...
- [x] 1.2 Validate the change with `npx openspec validate add-agent-definition-observability --strict --no-interactive`.
...
- [x] 2.1 After approval, create `docs/superpowers/plans/2026-06-18-add-agent-definition-observability.md`.
