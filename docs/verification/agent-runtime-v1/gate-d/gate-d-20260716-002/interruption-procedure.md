...
2. The supervisor records `OPERATOR_INTERRUPTION`, stops new admission and workers, terminates only the TS Runtime child, and retains the append-only journal.
...
6. No interruption or process exit authorizes promotion.
